...
Public Class POSWeb
    ...
    Public Shared Function HaveExcess(ByRef Page1 As Page, Optional ByVal isPopUp As Boolean = False, Optional ByVal isPMSAccessRight As Boolean = False) As Boolean
        ...
        If isPMSAccessRight Then
            ...
            If Page1.Session("POSWeb_user") = "0" Or Page1.Session("POSWeb_user") Is Nothing Then
                If isPopUp Then
                    Page1.Response.Redirect(ConfigurationManager.AppSettings("POSWeb_WebSiteURL") & "Login.aspx?expired=true&page=" & Page1.Request.Url.ToString & "")
                Else
                    Page1.Response.Redirect(ConfigurationManager.AppSettings("POSWeb_WebSiteURL") & "Login.aspx?expired=true&page=" & Page1.Request.Url.ToString & "")
                End If
                rtnBoolean = False
