<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Login.aspx.vb" Inherits="AgentMgmt.Login" %>
...
<body>
    <div class="container">
        <form id="form1" class="form-signin" runat="server">
            ...
            <asp:LinkButton ID="LinkButton1" runat="server" style="float:right;">Forgot Password</asp:LinkButton>
            <br />
